...
?>
	<!--[if lt IE 7]><style type="text/css">.seePlayOverlay {background:url(<?php echo get_option('siteurl') ?>/wp-content/plugins/seesmic-wp-plugin/images/playOverlay.gif)!important}</style><![endif]-->
	<script type="text/javascript" src="<?php echo get_option('siteurl'). '/' ?>wp-content/plugins/seesmic-wp-plugin/seesmic-wp-plugin.js"></script>
	<link href="<?php echo get_option('siteurl'). '/' ?>wp-content/plugins/seesmic-wp-plugin/seesmic-wp-plugin.css" rel="stylesheet" type="text/css" />
<?php	}} ?>
<?php 
...
?>
	...
	<div id="see_buttons_div">
		...
		<a href="http://wiki.seesmic.com/Wp-plugin" target="_blank"><img alt="Seesmic Logo" src="<?php echo get_option('siteurl'). '/' ?>wp-content/plugins/seesmic-wp-plugin/images/raccoon.png" width="130" height="41" style="cursor:pointer; cursor:hand;"/></a>
	</div>
...
?>
	...
	<div id="see_buttons_div">
		...
		<div class="see_buttons_and"> with</div>
		<a href="http://wiki.seesmic.com/Wp-plugin" target="_blank" style=" float:left"><img alt="Seesmic Logo" src="<?php echo get_option('siteurl'). '/' ?>wp-content/plugins/seesmic-wp-plugin/images/raccoon.png" width="130" height="41" onclick="see_set_comment_mode('videoRec','post')" style="cursor:pointer; cursor:hand;"/></a>
	</div>
